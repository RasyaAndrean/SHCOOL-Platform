...
const ManageClassroom = lazy(() => import('./pages/admin/ManageClassroom'));
const ManageClassroomResources = lazy(() =>
  import('./pages/admin/ManageClassroomResources')
);
...
const ManageLearningPaths = lazy(() =>
  import('./pages/admin/ManageLearningPaths')
);
...
const PortfolioAnalytics = lazy(() =>
  import('./pages/admin/PortfolioAnalytics')
);
      ...
      <Suspense fallback={<Loading />}>
        <Routes>
          ...
          <Route
            path="/structure"
            element={
              <Structure darkMode={darkMode} toggleDarkMode={toggleDarkMode} />
            }
          />
          <Route
            path="/resources"
            element={
              <Resources darkMode={darkMode} toggleDarkMode={toggleDarkMode} />
            }
          />
          <Route
            path="/contact"
          ...
          <Route
            path="/attendance"
            element={
              <Attendance darkMode={darkMode} toggleDarkMode={toggleDarkMode} />
            }
          />
          <Route
            path="/materials"
            element={
              <Materials darkMode={darkMode} toggleDarkMode={toggleDarkMode} />
            }
          />
          <Route
            path="/notifications"
          ...
          <Route
            ...
            element={
              <ProtectedRoute>
                <Feedback darkMode={darkMode} toggleDarkMode={toggleDarkMode} />
              </ProtectedRoute>
            }
          />
          <Route
          ...
          <Route
            ...
            element={
              <ProtectedRoute>
                <Reports darkMode={darkMode} toggleDarkMode={toggleDarkMode} />
              </ProtectedRoute>
            }
          />
          <Route
